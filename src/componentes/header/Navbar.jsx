        ...
        <nav className="cabecera">
            <ul className="nav categorias">
                ...
                <li className="nosotros link">
                    <NavLink to="/nosotros" activeclassname="active" className="imagen">NOSOTROS</NavLink>
                </li>
                <li className="contacto link">
                    <NavLink to="/contacto" activeclassname="active" className="imagen">CONTACTO</NavLink>
                </li>
            </ul>
        </nav>
    )
